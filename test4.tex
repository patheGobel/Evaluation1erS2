...
\begin{center}
    \begin{tabular}{@{} p{5cm} p{5cm} p{5cm} @{}} % 3 colonnes avec largeurs fixées
        Lycée Dindéfélo & \quad\quad\quad Test 4 & 30 Novembre 2024 \\
    \end{tabular}
...
\question
Construisez le point $Z$, barycentre du système $(E, 1)$, $(R, 3)$, $(T, -2),(F,5)$. 
\vspace{12cm}\\
\question
Soit le système ${(A\;,\ q)\ ;\ (B\;,\ c)\ ;\ (C\;,\ d)\ ;\ (D\;,\ e)}$ tel que $q+c+d+e\neq 0$, alors pour tout point $M$ du plan, on a :
\end{document}