...
\textbf{Signe des racines de \( (E) \)}

Cherchons $S$ et $P$
$S=\frac{-2m}{m+3}$ et $P=\frac{m+5}{m+3}$



\begin{tikzpicture}
    \tkzTabInit[espcl=2, lgt=5] % `lgt` augmente globalement la taille des colonnes
    {$m$ / 1 , $-8m-15$ / 1 , $S=\frac{-2m}{m+3}$ / 1 , $P=\frac{m+5}{m+3}$ / 1}
    {$-\infty$,$-5$, $-3$ ,$-\frac{15}{8}$,$0$, $+\infty$}
    \tkzTabLine{, +, t, +,d ,+, z,-, t , -}
    \tkzTabLine{, -, t, -,d ,+, ,+, z , -}
    \tkzTabLine{, +,z , -,d,+, z,+,t  , +}
\end{tikzpicture}

Sur $]-\infty ; -5]$ alors $P>0$ et $S<0$  donc \( (E) \) admet deux racines de signes négatif

Sur $]-3 ; -\frac{15}{8}[$ alors $P>0$ et $S>0$  donc \( (E) \) admet deux racines de signes positifs

Sur $]-5 ; -3[$ alors $P<0$  donc \( (E) \) admet deux racines de signes contraires
...
\begin{enumerate}
    ...
    \[
    2 \overrightarrow{GA} + 3 \overrightarrow{GB} +  \overrightarrow{GC} -  \overrightarrow{GD} = \overrightarrow{0}.
    \]
	...
	\[\text{Soit } G_{1}=bar\left\lbrace (A, 2);(C, 1) \right\rbrace \text{donc } \overrightarrow{AG_{1}}=\frac{1}{3}\overrightarrow{AC}\]
	\[\text{Soit } G_{2}=bar\left\lbrace (B, 3);(D, -1) \right\rbrace \text{donc } \overrightarrow{BG_{2}}=\frac{-1}{2}\overrightarrow{BD} \]
    \[
		G=bar\left\lbrace (G_{1}, 3);(G_{2}, 2) \right\rbrace
    \]
    \[
		\overrightarrow{GG_{1}}=\frac{2}{3}\overrightarrow{G_{1}G_{2}}
    \]
\begin{center}
\begin{tikzpicture}[scale=1.5]
    ...
    \coordinate (C) at (4, 4);
    \coordinate (D) at (0, 4);
    \coordinate (O) at (2, 2); % Centre du carré
    ...
    \filldraw[black] (D) circle (1pt) node[above left] {\(D\)};
    ...
    \coordinate (G) at (1.8, 1.2); % Coordonnées approximatives après pondération
    
    % Point G
    \filldraw[red] (G) circle (1.5pt) node[below] {\(G\)};
...
Le point \(G\) est construit en respectant la règle de pondération, avec une approximation visuelle des coordonnées.
