...
\begin{aligned}
        ...
        &\implies \cos \widehat{BAC}=\frac{-7}{2\times 4\sqrt{2}}\\
        &\implies \cos \widehat{BAC}=\frac{-7}{8\sqrt{2}}\\
        &\implies \cos \widehat{BAC}=\frac{-7\sqrt{2}}{16}\\
\end{aligned}
        \)
        
\begin{resultbox}
    \[
    \mathbf{cos \widehat{BAC}=\frac{-7\sqrt{2}}{16}}
    \]
\end{resultbox} 

        \item L'ensemble des points \( M \) du plan tels que \( \overrightarrow{BA} \cdot \overrightarrow{MC} = 0 \).
        
        L'ensemble des points \( M \) du plan est la perpendiulaire à (AB) passant par C.
    \end{enumerate}
